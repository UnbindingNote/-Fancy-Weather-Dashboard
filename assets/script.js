...
//Add buttons based on search history 
function getHistory() {
	contHistEl.empty();
	...
	//History buttons can search as well
...
//Set 'Today' card body to a variable.
//Apply data to the today card and the five day forecast
function getWeatherToday() {
	...
	$.ajax({
		...
		$.ajax({
			...
			//set UV index to match severity based on color 
			if (uvi >= 0 && uvi <= 2) {
